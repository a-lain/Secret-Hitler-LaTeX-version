...
\begin{document}
	\begin{tikzpicture}		
		...
		\node at (14.35,3.6) [fascist] {\fontsize{10}{10}\selectfont \begin{tabular}{c}
				EL PRESIDENTE\\ EXAMINA LAS TRES\\ PRIMERAS CARTAS.
		\end{tabular}};
		...
		\node at (16.8, 1) [fascist] {\fontsize{13}{13}\selectfont 5 O 6 JUGADORES: JUÉGUESE CON 1 FASCISTA Y HITLER; HITLER SABE QUIÉN ES EL FASCISTA.};
