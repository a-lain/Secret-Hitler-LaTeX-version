...
\begin{document}
	\begin{tikzpicture}		
		...
		\begin{scope}[xshift=1.5cm, yshift=0.55cm, scale=1.2]
			...
			\fill [white, rounded corners] (-0.5,\y) rectangle (0.5,\y+0.618);
		\end{scope}
		\node at (1.7, 6) [white, rotate=90] {\fontsize{20}{20}\selectfont \begin{tabular}{c}
				MAZO DE\\ POLÍTICAS
			\end{tabular}};
		...
		\begin{scope}[xshift=32.1cm, yshift=0.55cm, scale=1.2]
			...
			\fill [white, rounded corners] (-0.5,\y) rectangle (0.5,\y+0.618);
		\end{scope}
		\node at (31.9, 6) [white, rotate=-90] {\fontsize{20}{20}\selectfont \begin{tabular}{c}
				MAZO DE\\ DESCARTES
			\end{tabular}};
		...
		% Election tracker
		\node at (9, 1.05) [liberal] {\fontsize{13}{13}\selectfont \begin{tabular}{c}
				PROCESO DE\\ ELECCIÓN
		\end{tabular}};
		...
		\foreach \x in {11.4, 15, 18.6}
		{
			\begin{scope}[xshift=\x cm, yshift=1.05cm]
				...
				\node at (1.4, 0) [liberal] {\fontsize{8}{8}\selectfont \begin{tabular}{c}
						FRACASO
				\end{tabular}};
		...
		\begin{scope}[xshift=22.2 cm, yshift=1.05cm]
			\draw [liberal, line width=3]  (0,0) circle (4mm);
			\draw [liberal, line width=3, dotted]  (0,0) circle (6mm);
			\node at (2.2, 0) [liberal] {\fontsize{9}{9}\selectfont \begin{tabular}{c}
				MUÉSTRESE Y\\ PROMÚLGUESE LA\\ PRIMERA POLÍTICA\\DEL MAZO
			\end{tabular}};
		\end{scope}
