...
\begin{document}
	\begin{tikzpicture}		
		...
		\node at (9.45,3.6) [fascist] {\fontsize{10}{10}\selectfont \begin{tabular}{c}
			THE PRESIDENT\\INVESTIGATES A\\PLAYER'S INDENTITY\\CARD.
		\end{tabular}};		
		...
		\node at (16.8, 1) [fascist] {\fontsize{13}{13}\selectfont 7 OR 8 PLAYERS: PLAY WITH 2 FASCISTS AND HITLER, HITLER DOESN'T KNOW WHO THE FASCISTS ARE.};
